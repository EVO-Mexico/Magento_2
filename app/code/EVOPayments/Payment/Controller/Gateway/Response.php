...
namespace EVOPayments\Payment\Controller\Gateway;
...
class Response extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        if (!isset($additionalInformation['originalMerchantTxId']) || $additionalInformation['originalMerchantTxId'] == '') {
            $this->_redirect($urlInterface->getUrl('evopayments_payment/standard/cancel'));
            return;
        }
        ...
        $url = $urlInterface->getUrl('evopayments_payment/standard/cancel');
