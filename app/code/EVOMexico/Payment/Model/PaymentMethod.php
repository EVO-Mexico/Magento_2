...
namespace EVOMexico\Payment\Model;


use EVOMexico\Payment\Model\Config\Source\Brand;
use EVOMexico\Payment\Helper\Helper;
use EVOMexico\Payment\Model\Config\Source\NewOrderPaymentActions;
...
class PaymentMethod extends \Magento\Payment\Model\Method\AbstractMethod implements GatewayInterface
{
    ...
    /**
     * @var \EVOMexico\Payment\Helper\Helper
     */
    private $_helper;
    /**
    ...
    public function getCheckoutRedirectUrl()
    {
       ...
       if ($displayMode === DisplayMode::DISPLAY_MODE_IFRAME) {
           $redirectUrl = 'evomexico/hosted/iframe';
        } else {
            $redirectUrl = 'evomexico/hosted/redirect';
        }
