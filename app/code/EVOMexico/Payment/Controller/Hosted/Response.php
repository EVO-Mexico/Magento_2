...
namespace EVOMexico\Payment\Controller\Hosted;
...
>>>>>>> fa93dae066f6f222e73dc34e0fa02cd278f41954
            $order->save();
            $redirectUrl = $urlInterface->getUrl('checkout/onepage/failure/');
        }
        $params['redirectUrl'] = $redirectUrl;

        $this->registry->register(\EVOMexico\Payment\Block\Response::REGISTRY_PARAMS_KEY, $params);
