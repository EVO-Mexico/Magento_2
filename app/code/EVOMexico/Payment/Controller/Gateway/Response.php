...
namespace EVOMexico\Payment\Controller\Gateway;
...
class Response extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        if (!isset($additionalInformation['originalMerchantTxId']) || $additionalInformation['originalMerchantTxId'] == '') {
            $this->_redirect($urlInterface->getUrl('evomexico_payment/standard/cancel'));
            return;
        }
        ...
        $url = $urlInterface->getUrl('evomexico_payment/standard/cancel');
